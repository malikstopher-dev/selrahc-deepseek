...
const images = (start: number, count: number): string[] =>
  Array.from({ length: count }, (_, i) => `/images/image-${String(start + i).padStart(2, '0')}.jpg`)
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    descriptionFr: 'Une retraite de week-end qui embrasse la matérialité brute et la construction honnête. Béton apparent, acier et verre.',
    heroImage: '/images/image-54.jpg',
    images: images(54, 6),
    featured: false,
    area: '550 m²',
  },
